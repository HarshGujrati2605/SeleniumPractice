...
public class RadioButton {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement radiobtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@value = 'Male']")));
        boolean selectionstate = radiobtn.isSelected();
        ...
        selectionstate= radiobtn.isSelected();
        System.out.println(selectionstate);
	}
